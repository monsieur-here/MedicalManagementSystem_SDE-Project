...
INSERT INTO `admin` VALUES (156,'medical1','password','medical@gmail.com');
...
INSERT INTO `doctor` VALUES (1,'Siddharth','Cardiology','6309871543','',0);
...
DROP TABLE IF EXISTS `support_call`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
...
LOCK TABLES `support_call` WRITE;
/*!40000 ALTER TABLE `support_call` DISABLE KEYS */;
/*!40000 ALTER TABLE `support_call` ENABLE KEYS */;
UNLOCK TABLES;
...
-- Dump completed on 2025-05-30 17:50:15
