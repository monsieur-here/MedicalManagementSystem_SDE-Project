...
CREATE TABLE `combined_medical_record` (
  ...
  `Bill_amount` binary(10) NOT NULL,
...
INSERT INTO `registration` VALUES ('Alice Smith','Female','9123456780','1985-03-22','456 Oak Ave, CA','alice.smith@medcare.com','Alice@1985',20001),('Bob Johnson','Male','9988776655','1978-11-10','789 Maple Dr, TX','bob.johnson@medcare.com','BobJ@78',0),('Chris Evans','Male','8887766554','1992-07-18','202 Cedar Blvd, WA','chris.evans@medcare.com','ChrisE@92',0),('Claire Meyer','Female','15699876541','1983-03-09','Heidelberg','claire.meyer@medcare.com','Claire@123',0),('Emily Davis','Female','9001122334','2000-08-30','101 Pine Rd, FL','emily.davis@medcare.com','EmilyD#00',0),('Helena Rossi','Female','15598321756','1980-01-19','Mannheim','helena.rossi@medcare.com','Helena#80',0),('John Doe','Male','9876543210','1990-05-14','123 Elm Street, NY','john.doe@medcare.com','JohnD!90',0);
...
-- Dump completed on 2025-06-10 22:38:15
